package simulationdemo.application.list;
...
public class SimulationDemoSimulationPanelApp extends BaseJSPPanelApp {
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=simulationdemo)",
		unbind = "-"
	)
