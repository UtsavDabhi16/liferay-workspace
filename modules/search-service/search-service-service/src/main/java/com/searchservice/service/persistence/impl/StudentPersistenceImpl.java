...
package com.searchservice.service.persistence.impl;
...
import com.searchservice.exception.NoSuchStudentException;
import com.searchservice.model.Student;
import com.searchservice.model.StudentTable;
import com.searchservice.model.impl.StudentImpl;
import com.searchservice.model.impl.StudentModelImpl;
import com.searchservice.service.persistence.StudentPersistence;
import com.searchservice.service.persistence.StudentUtil;
import com.searchservice.service.persistence.impl.constants.searchPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	public void clearCache() {
		dummyEntityCache.clearCache(StudentImpl.class);

		dummyFinderCache.clearCache(StudentImpl.class);
	}
	...
	public void clearCache(Student student) {
		dummyEntityCache.removeResult(StudentImpl.class, student);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			dummyEntityCache.removeResult(StudentImpl.class, primaryKey);
		}
	}
	...
	public Student updateImpl(Student student) {
		...
		dummyEntityCache.putResult(StudentImpl.class, student, false, true);
	...
	public List<Student> findAll(
		...
		if (useFinderCache) {
			list = (List<Student>)dummyFinderCache.getResult(
	...
	public void deactivate() {
		...
		dummyEntityCache.removeCache(StudentImpl.class.getName());
	}
