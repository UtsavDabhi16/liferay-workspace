...
import headless.apps.client.resource.v1_0.AppResource;
...
public abstract class BaseAppResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(headless.apps.dto.v1_0.App.class)) {
	...
	@Inject
	private headless.apps.resource.v1_0.AppResource _appResource;
