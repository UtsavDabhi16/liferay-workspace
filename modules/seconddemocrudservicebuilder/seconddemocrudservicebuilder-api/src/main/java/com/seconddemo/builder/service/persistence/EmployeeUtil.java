...
package com.seconddemo.builder.service.persistence;
...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.seconddemo.builder.exception.NoSuchEmployeeException {
