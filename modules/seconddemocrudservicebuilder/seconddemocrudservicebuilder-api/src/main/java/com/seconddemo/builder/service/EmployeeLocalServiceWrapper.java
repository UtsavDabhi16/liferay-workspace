...
package com.seconddemo.builder.service;
...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.seconddemo.builder.model.Employee addEmployee(
		com.seconddemo.builder.model.Employee employee) {
	 ...
	 */
	@Override
	public com.seconddemo.builder.model.Employee createEmployee(int eid) {
	 ...
	 */
	@Override
	public com.seconddemo.builder.model.Employee deleteEmployee(
		com.seconddemo.builder.model.Employee employee) {
	 ...
	 */
	@Override
	public com.seconddemo.builder.model.Employee deleteEmployee(int eid)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.seconddemo.builder.model.Employee fetchEmployee(int eid) {
	 ...
	 */
	@Override
	public com.seconddemo.builder.model.Employee getEmployee(int eid)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.seconddemo.builder.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public com.seconddemo.builder.model.Employee updateEmployee(
		com.seconddemo.builder.model.Employee employee) {
