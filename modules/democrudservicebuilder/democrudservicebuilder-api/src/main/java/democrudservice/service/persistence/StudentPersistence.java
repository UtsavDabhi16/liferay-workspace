...
public interface StudentPersistence extends BasePersistence<Student> {
	 ...
	 */
	public java.util.List<Student> findByCity(String city);
	 ...
	 */
	public java.util.List<Student> findByCity(String city, int start, int end);
	 ...
	 */
	public java.util.List<Student> findByCity(
