...
public class StudentUtil {
	 ...
	 */
	public static List<Student> findByCity(String city) {
	 ...
	 */
	public static List<Student> findByCity(String city, int start, int end) {
	 ...
	 */
	public static List<Student> findByCity(
	 ...
	 */
	public static Student findByCity_First(
			String city, OrderByComparator<Student> orderByComparator)
		throws democrudservice.exception.NoSuchStudentException {
	 ...
	 */
	public static Student fetchByCity_First(
		String city, OrderByComparator<Student> orderByComparator) {
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByCity_Last(
			String city, OrderByComparator<Student> orderByComparator)
		throws democrudservice.exception.NoSuchStudentException {
	 ...
	 */
	public static Student fetchByCity_Last(
		String city, OrderByComparator<Student> orderByComparator) {
	 ...
	 */
	public static Student[] findByCity_PrevAndNext(
	 ...
	 * @return the range of matching students
	 */
	public static List<Student> findByLastName(
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByLastName_First(
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByLastName_First(
		String lastName, OrderByComparator<Student> orderByComparator) {
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByLastName_Last(
			String lastName, OrderByComparator<Student> orderByComparator)
		throws democrudservice.exception.NoSuchStudentException {
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByLastName_Last(
		String lastName, OrderByComparator<Student> orderByComparator) {
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] findByLastName_PrevAndNext(
			long studentId, String lastName,
			OrderByComparator<Student> orderByComparator)
		throws democrudservice.exception.NoSuchStudentException {

		return getPersistence().findByLastName_PrevAndNext(
			studentId, lastName, orderByComparator);
	}
