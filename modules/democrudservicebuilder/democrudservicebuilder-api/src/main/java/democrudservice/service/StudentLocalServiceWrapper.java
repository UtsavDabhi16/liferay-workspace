...
public class StudentLocalServiceWrapper
	 ...
	 */
	@Override
	public democrudservice.model.Student addStudent(
		democrudservice.model.Student student) {
	 ...
	 */
	@Override
	public democrudservice.model.Student createStudent(long studentId) {
	 ...
	 */
	@Override
	public democrudservice.model.Student deleteStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public democrudservice.model.Student deleteStudent(
		democrudservice.model.Student student) {
	...
	@Override
	public democrudservice.model.Student fetchStudent(long studentId) {
		return _studentLocalService.fetchStudent(studentId);
	}

	@Override
	public java.util.List<democrudservice.model.Student> findByEntryfirstkName(
			long studentId)
		throws com.liferay.portal.kernel.exception.SystemException {

		return _studentLocalService.findByEntryfirstkName(studentId);
	}
	...
	@Override
	public java.util.List<democrudservice.model.Student> getForPagination(
		int start, int end) {

		return _studentLocalService.getForPagination(start, end);
	}
	 ...
	 */
	@Override
	public democrudservice.model.Student getStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public java.util.List<democrudservice.model.Student> getStudentByFistName(
		String firstName) {

		return _studentLocalService.getStudentByFistName(firstName);
	}

	@Override
	public java.util.List<democrudservice.model.Student> getStudentFormCity(
			String city)
		throws com.liferay.portal.kernel.exception.SystemException {

		return _studentLocalService.getStudentFormCity(city);
	}
	 ...
	 */
	@Override
	public java.util.List<democrudservice.model.Student> getStudents(
		int start, int end) {
	...
	public void removeByLastName(String lastName) {
		_studentLocalService.removeByLastName(lastName);
	}
	 ...
	 */
	@Override
	public democrudservice.model.Student updateStudent(
		democrudservice.model.Student student) {
