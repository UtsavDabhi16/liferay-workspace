 ...
 * <code>democrudservice.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>democrudservice.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Student> findByEntryfirstkName(long studentId)
		throws SystemException {

		return getService().findByEntryfirstkName(studentId);
	}
	...
	public static List<Student> getForPagination(int start, int end) {
		return getService().getForPagination(start, end);
	}
	...
	public static List<Student> getStudentByFistName(String firstName) {
		return getService().getStudentByFistName(firstName);
	}

	public static List<Student> getStudentFormCity(String city)
		throws SystemException {

		return getService().getStudentFormCity(city);
	}
	...
	public static void removeByLastName(String lastName) {
		getService().removeByLastName(lastName);
	}
