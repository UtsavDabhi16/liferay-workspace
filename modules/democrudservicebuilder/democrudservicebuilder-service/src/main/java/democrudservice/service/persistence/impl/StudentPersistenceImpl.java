...
import democrudservice.exception.NoSuchStudentException;

import democrudservice.model.Student;
import democrudservice.model.StudentTable;
import democrudservice.model.impl.StudentImpl;
import democrudservice.model.impl.StudentModelImpl;

import democrudservice.service.persistence.StudentPersistence;
import democrudservice.service.persistence.StudentUtil;
import democrudservice.service.persistence.impl.constants.studPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	/**
	 * Returns all the students where city = &#63;.
	 *
	 * @param city the city
	...
	/**
	 * Returns a range of all the students where city = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<Student> findByCity(String city, int start, int end) {
		return findByCity(city, start, end, null);
	}

	/**
	 * Returns an ordered range of all the students where city = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Student> findByCity(
	...
	/**
	 * Returns the first student in the ordered set where city = &#63;.
	 *
	 * @param city the city
	 ...
	 */
	@Override
	public Student findByCity_First(
			String city, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByCity_First(city, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByCity_First(
		String city, OrderByComparator<Student> orderByComparator) {

		List<Student> list = findByCity(city, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last student in the ordered set where city = &#63;.
	 *
	 * @param city the city
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Student findByCity_Last(
			String city, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByCity_Last(city, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByCity_Last(
		String city, OrderByComparator<Student> orderByComparator) {
	...
	/**
	 * Returns the students before and after the current student in the ordered set where city = &#63;.
	 *
	 ...
	 */
	@Override
	public Student[] findByCity_PrevAndNext(
		...
		try {
			...
			array[0] = getByCity_PrevAndNext(
				session, student, city, orderByComparator, true);

			array[1] = student;

			array[2] = getByCity_PrevAndNext(
				session, student, city, orderByComparator, false);
	...
	protected Student getByCity_PrevAndNext(
		Session session, Student student, String city,
	...
	/**
	 * Removes all the students where city = &#63; from the database.
	 *
	 * @param city the city
	 */
	@Override
	...
	/**
	 * Returns the number of students where city = &#63;.
	 *
	 * @param city the city
	...
	private static final String _FINDER_COLUMN_CITY_CITY_2 = "student.city = ?";

	private static final String _FINDER_COLUMN_CITY_CITY_3 =
		"(student.city IS NULL OR student.city = '')";
	...
	/**
	 * Returns all the students where lastName = &#63;.
	 *
	...
	/**
	 * Returns a range of all the students where lastName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Student> findByLastName(String lastName, int start, int end) {
		return findByLastName(lastName, start, end, null);
	}

	/**
	 * Returns an ordered range of all the students where lastName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first student in the ordered set where lastName = &#63;.
	 *
	 * @param lastName the last name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching student
	 ...
	 */
	@Override
	public Student findByLastName_First(
			String lastName, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByLastName_First(lastName, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByLastName_First(
		String lastName, OrderByComparator<Student> orderByComparator) {

		List<Student> list = findByLastName(lastName, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last student in the ordered set where lastName = &#63;.
	 *
	 * @param lastName the last name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching student
	 ...
	 */
	@Override
	public Student findByLastName_Last(
			String lastName, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByLastName_Last(lastName, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByLastName_Last(
		String lastName, OrderByComparator<Student> orderByComparator) {
		...
		List<Student> list = findByLastName(
	...
	/**
	 * Returns the students before and after the current student in the ordered set where lastName = &#63;.
	 *
	 * @param studentId the primary key of the current student
	 * @param lastName the last name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Student[] findByLastName_PrevAndNext(
			long studentId, String lastName,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {
		...
		try {
			...
			array[0] = getByLastName_PrevAndNext(
				session, student, lastName, orderByComparator, true);

			array[1] = student;

			array[2] = getByLastName_PrevAndNext(
				session, student, lastName, orderByComparator, false);
	...
	protected Student getByLastName_PrevAndNext(
		Session session, Student student, String lastName,
		OrderByComparator<Student> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the students where lastName = &#63; from the database.
	 *
	 * @param lastName the last name
	 */
	@Override
