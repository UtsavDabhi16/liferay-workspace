 ...
 * <code>eventdemo.service.impl.DataLocalServiceImpl</code> and
...
public class DataLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>eventdemo.service.impl.DataLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new data
	 */
	public static Data createData(long eventId) {
	 ...
	 */
	public static Data deleteData(Data data) {
	 ...
	 */
	public static Data deleteData(long eventId) throws PortalException {
	...
	public static Data fetchData(long eventId) {
	 ...
	 * @throws PortalException if a data with the primary key could not be found
	 */
	public static Data getData(long eventId) throws PortalException {
	 ...
	 */
	public static List<Data> getDatas(int start, int end) {
	 ...
	 */
	public static Data updateData(Data data) {
	...
	private static volatile DataLocalService _service;
