 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eventdemo.service.impl.DataLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eventdemo.service.impl.DataLocalServiceImpl
 * @generated
 */
public abstract class DataLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DataLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DataLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DataLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dataPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Data.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dataPersistence.findWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dataPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	@Override
	public BasePersistence<Data> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DataLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dataLocalService = (DataLocalService)aopProxy;

		_setLocalServiceUtilService(dataLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		DataLocalService dataLocalService) {

		try {
			Field field = DataLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dataLocalService);
		}
